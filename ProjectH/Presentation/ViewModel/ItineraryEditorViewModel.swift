...
final class ItineraryEditorViewModel: ViewModel, ObservableObject, ItineraryEditorViewModelOutput, Identifiable {
  ...
  private let baseCategory: ItineraryCategory
  ...
  var canUnschedule: Bool {
    isEditing && showsTimeToggle && hasTime
  }
  ...
  var isHourAvailable: Bool {
    guard showsTimeToggle, hasTime else { return true }
  ...
  var showsLodgingRange: Bool {
    baseCategory == .lodging
  }

  var showsTimeToggle: Bool {
    baseCategory == .place || baseCategory == .sight
  }
